      ...
      <div className="bg-[#111] text-white p-4 sm:p-6 rounded-lg shadow-md h-full">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="relative flex items-center justify-center">
            <svg className="w-16 h-16 sm:w-18 sm:h-18 transform -rotate-90" viewBox="0 0 100 100">
              <circle
            ...
            <span className="absolute text-base sm:text-lg font-semibold">{progressPercentage}%</span>
          </div>
